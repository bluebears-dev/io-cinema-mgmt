...
class UserTest(CinemaModelTest):
  ...
  def test_create_wrong_values(self):
    ...
    try:
      ...
      UserProfile.objects.create(user=User.objects.get(username='okon', password='noko'), phone_number=None)
    ...
    try:
      ...
      UserProfile.objects.create(user=None, phone_number="1213897009")
    ...
    UserProfile.objects.create(user=User.objects.get(username='alalalalj', password='passwd'),
                               phone_number="999999999999")

    ###
    try:

      UserProfile.objects.create(user=User.objects.get(username='okon', password='noko'),
